...
<head>
    ...
    <title>To'yxona va banket zallarni ijaraga olish</title>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    @guest
                        @if (Route::has('login'))
                            <li class="nav-item">
                                <a class="btn btn-primary m-lg-3" href="{{ route('login') }}">Tizimga kirish</a>
                            </li>
                        @endif

                        @if (Route::has('register'))
                            <li class="nav-item">
                                <a class="btn btn-secondary m-lg-3" href="{{ route('register') }}">Ro'yxatdan o'tish</a>
                            </li>
                        @endif
                    @else
...
@endif
    ...
    <footer>
        @if (Route::has('login'))
{{--            <div class="">Sizda to'yxona mavjudmi? Agar mavjud bo'lsa ro'yxatdan o'ting va tizimga kiring!--}}
{{--                @auth--}}
{{--                    <a href="{{ url('/home') }}" class="text-sm text-gray-700 dark:text-gray-500 underline " style="margin-left: 100px;">Asosiy oyna</a>--}}
{{--                @else--}}
{{--                    <a href="{{ route('login') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Tizimga kirish</a>--}}

{{--                    @if (Route::has('register'))--}}
{{--                        <a href="{{ route('register') }}" class="ml-4 text-sm text-gray-700 dark:text-gray-500 underline">Ro'yxatdan o'tish</a>--}}
{{--                    @endif--}}
{{--                @endauth--}}
{{--            </div>--}}
        @endif
